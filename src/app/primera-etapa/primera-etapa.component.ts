...
export class PrimeraEtapaComponent implements OnInit {
  ...
  constructor(  public alumnoService: PrimeraEtapaService, private auth: AuthService, private router:Router, private ExporterService: ExporterService) { }
